...

{
    ...
    sub new {
        ...
        $template_home = "/home/article/Article/root/static/tmpl";
...
#        print $http_header[$http_header_var]; 
        ...
        __set_template_variable($self, "home_page",         "http://article.soupmode.com/static");
       ...
       # __set_template_variable($self, "css_dir_url",       Config::get_value_for("css_dir_url")); 
        __set_template_variable($self, "site_description",  "Test Static Pages");
        __set_template_variable($self, "css_dir_url",       "http://article.soupmode.com/static/css");
